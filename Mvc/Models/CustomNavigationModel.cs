...
namespace SitefinityWebApp.Mvc.Models
{
    ...
    {
        public CustomNavigationModel() : base()
        {
        ...
        protected override NodeViewModel InstantiateNodeViewModel(SiteMapNode node)
        {
            ...
            return new CustomNavigationViewModel(node, url, target, isSelectedPage, hasSelectedChild);
        }

        protected override NodeViewModel InstantiateNodeViewModel(string url, string target)
        {
            return new CustomNavigationViewModel(null, url, target, false, false);
        }
    }
}